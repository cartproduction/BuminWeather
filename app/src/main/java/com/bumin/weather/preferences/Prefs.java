package com.bumin.weather.preferences;
...
public class Prefs {
    ...
    public void setIcon(String id) {
        prefs.edit().putString(Constants.LARGE_WIDGET_ICON , id).apply();
    }
    ...
    public void saveWeather(Weather weather) {
        setTemperature(Double.parseDouble(MyApplication.weatherData.getCurrentCondition().get(0).getTempC()));
        setPressure(Double.parseDouble(MyApplication.weatherData.getCurrentCondition().get(0).getPressure()));
        setHumidity(Integer.parseInt(MyApplication.weatherData.getCurrentCondition().get(0).getHumidity()));
        setSpeed(Float.parseFloat(MyApplication.weatherData.getCurrentCondition().get(0).getPressure()));
        setIcon(MyApplication.weatherData.getCurrentCondition().get(0).getWeatherIconUrl().get(0).getValue());
        setCountry(MyApplication.weatherData.getRequest().get(0).getQuery());
        setDescription(MyApplication.weatherData.getCurrentCondition().get(0).getWeatherDesc().get(0).getValue());
    }
}
